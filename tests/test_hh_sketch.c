...
Test(hh_sketch, hh_top_only_median, .disabled=0) {
	uint32_t A[10][2] = {
		{1, 3543},
		{2, 7932},
		{3, 8234},
...
Test(hh_sketch, hh_top_only_min, .disabled=0) {
	uint32_t A[10][2] = {
		{1, 3543},
		{2, 7932},
		{3, 8234},
...
Test(hh_sketch, hh_top_and_bottom_median, .disabled=0) {
	double hh_mass   = 0.70;
	uint32_t m       = pow(2, 20);
	...
	cr_expect_eq(result->count, 7, "Heavy hitters (%d) should be 7", result->count);
...
Test(hh_sketch, hh_top_and_bottom_close_non_hh_median, .disabled=0) {
