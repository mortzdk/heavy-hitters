...
Test(hh_cormode, hh_top_only, .disabled=0) {
	uint32_t A[10][2] = {
		{1, 3543},
		{2, 7932},
		{3, 8234},
	...
	hh_cormode_cmh_params_t params = {
		.b       = 2,
		.epsilon = 0.01,
		.delta   = 0.2,
		.m       = pow(2, 9),
...
Test(hh_cormode, hh_top_and_bottom, .disabled=0) {
	double hh_mass   = 0.70;
	uint32_t m       = pow(2, 20);
...
Test(hh_cormode, hh_top_and_bottom_close_non_hh, .disabled=0) {
